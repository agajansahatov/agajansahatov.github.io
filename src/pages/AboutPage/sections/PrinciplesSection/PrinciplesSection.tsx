import { FaAward, FaGlobe, FaHeart, FaUsers } from 'react-icons/fa6';
...
const PrinciplesSection = () => {
	...
	return (
		<Block className={styles.section} containerClassName={styles.container}>
			<BlockHeader dataAos='fade-up' className={styles.header}>
				<h2 className={styles.title}>{t.about.principlesTitle}</h2>
			</BlockHeader>
			...
			>
				{t.about.principles.map((principle, index) => (
					...
					>
						<Card isScalableOnHover className={styles.card}>
							<Icon
