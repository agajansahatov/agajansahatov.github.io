...
const workExperienceAssets: readonly ExperienceAsset<WorkExperienceId>[] = [
	{
		...
		logoIcon: FaTruck,
		iconVariant: 'accent',
		organizationUrl: 'http://xcargo.com.tm/',
		tech: [
			'MySQL',
			'Workbench',
			'Prisma',
	...
	},
	{
		...
		logoIcon: FaCode,
		iconVariant: 'success',
		organizationUrl: 'https://www.tyut.edu.cn/',
...
const educationAssets: readonly ExperienceAsset<EducationId>[] = [
	{
		...
		iconVariant: 'info',
		organizationUrl: 'https://www.ncu.edu.cn/',
	...
	},
	{
		...
		logoIcon: FaLanguage,
		iconVariant: 'warning',
		organizationUrl: 'https://www.xisu.edu.cn/',
		...
		return [
			{
				...
				organizationUrl: asset.organizationUrl,
				tech: asset.tech,
